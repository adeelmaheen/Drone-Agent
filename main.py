...
def create_3d_plot():
    try:
        ...
        fig.update_layout(
            ...
            uirevision='constant'  # Prevents plot reset on update
        )
        return fig
    except Exception as e:
...
try:
    ...
    if current_time - st.session_state.last_update >= 1.0 / speed:
        update_simulation()
        st.session_state.last_update = current_time
    fig = create_3d_plot()
    plot_placeholder.plotly_chart(fig, use_container_width=True, key='plot')
except Exception as e:
